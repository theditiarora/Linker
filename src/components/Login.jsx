...
const Login = () => {
  ...
  return (
    <div>
      ...
      <input
        value={loginEmail}
        onClick={(e) => setLoginEmail(e.target.value)}
      ...
      <input
        value={loginPass}
        onClick={(e) => setLoginPass(e.target.value)}
        placeholder="······"
        className="input-field mt-3 w-2/4"
        type="password"
      />
      ...
      <button
        ...
        className="block mt-8 py-2 px-12 text-white rounded-md bg-blue hover:bg-opacity-70 transition-all duration-200"
      >
        Log in
      </button>
